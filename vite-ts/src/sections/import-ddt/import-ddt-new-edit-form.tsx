...
import { ImportDdtNewEditAddress } from './import-ddt-new-edit-address';
import { ImportDdtNewEditStatusDate } from './import-ddt-new-edit-status-date';
import { defaultItem, ImportDdtNewEditDetails } from './import-ddt-new-edit-details';
...
export function ImportDdtNewEditForm({ currentInvoice }: Props) {
  ...
  return (
    <Form methods={methods}>
      <Card>
        <ImportDdtNewEditAddress />

        <ImportDdtNewEditStatusDate />

        <ImportDdtNewEditDetails />
      </Card>
