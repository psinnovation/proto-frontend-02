...
import { ImportDdtToolbar } from './import-ddt-toolbar';
import { ImportDdtTotalSummary } from './import-ddt-total-summary';
...
export function ImportDdtDetails({ invoice }: Props) {
